...
const faqData = [
  {
    ...
    answer:
      "Your first wash is completely free up to ₹200. Simply download the app, schedule your first pickup, and the discount will be automatically applied to your order. Any amount exceeding ₹200 will be charged normally.",
  },
  {
